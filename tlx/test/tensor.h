...
typedef int _stride_t  __attribute__((__vector_size__(16), __aligned__(4)));
typedef int _window_t  __attribute__((__vector_size__(16), __aligned__(4)));
...
_tensor_t tensor_reduce_add(_token_t, _window_t, _stride_t);
_tensor_t tensor_reduce_min(_token_t, _window_t, _stride_t);
_tensor_t tensor_reduce_max(_token_t, _window_t, _stride_t);
_tensor_t tensor_reduce_mul(_token_t, _window_t, _stride_t);
